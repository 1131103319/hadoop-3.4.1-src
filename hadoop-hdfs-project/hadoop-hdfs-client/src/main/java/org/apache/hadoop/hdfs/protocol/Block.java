...
/**
 * todo Block类用来唯一地标识Namenode中的数据块， 是HDFS数据块最基本的抽象接口。
 *  Block类实现了Writable接口， 是可以序列化的。
 *  Block类还实现了Comparable接口，按照blockid大小排序。
 */
public class Block implements Writable, Comparable<Block> {
    ...
    //todo ①blockId唯一地标识这个Block对象；
    private long blockId;
    //todo ②numBytes是这个数据块的大小（单位是字节） ;
    private long numBytes;
    //todo ③generationStamp是这个数据块的时间戳 。
