...
public class SecondaryNameNode implements Runnable,
    ...
    public void startInfoServer() throws IOException {
        ...
        //todo     // 默认: dfs.namenode.secondary.http-address : 0.0.0.0:9869
        ...
        HttpServer2.Builder builder = DFSUtil.httpServerTemplateForNNAndJN(conf,
                ...
                DFSConfigKeys.DFS_SECONDARY_NAMENODE_KEYTAB_FILE_KEY);
        //todo // dfs.xframe.enabled : 默认 true
        //todo   如果为true，则通过返回设置为SAMEORIGIN的X_FRAME_OPTIONS标题值来启用防止单击劫持的保护。
        //    //  Clickjacking保护可防止攻击者使用透明或不透明层诱骗用户单击另一页上的按钮或链接。
        final boolean xFrameEnabled = conf.getBoolean(
                DFSConfigKeys.DFS_XFRAME_OPTION_ENABLED,
                DFSConfigKeys.DFS_XFRAME_OPTION_ENABLED_DEFAULT);
        //todo     // dfs.xframe.value : SAMEORIGIN   可选:  DENY  SAMEORIGIN    ALLOW-FROM
    ...
    public boolean doCheckpoint() throws IOException {
        ...
        //todo // 告诉namenode在新的edits文件中开始记录事务 , 如果处于安全模式则失败.
        ...
        //todo     // 拉取fsimage和edits, 如果merge失败则重新加载image
