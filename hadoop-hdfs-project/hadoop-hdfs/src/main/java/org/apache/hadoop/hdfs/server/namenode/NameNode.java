...
public class NameNode extends ReconfigurableBase implements
    ...
    private static boolean format(Configuration conf, boolean force,
        ...
        if (clusterId == null || clusterId.equals("")) {
            ...
            //todo       //Generate a new cluster id   生成新的id  举例: CID-UUID  ==>  CID-d5e21420-46b8-41fb-acc7-8562be611472
        ...
        //todo 构建 FSImage
        //todo VERSION    记录版本信息
        //todo fsimage_0000000000000000000.md5   记录fsimage_0000000000000000000对应的md5
        //todo fsimage_0000000000000000000 namenode对应的fsimage文件
        //todo seen_txid 事务标识
