...
public class ClientRMService extends AbstractService implements
    ...
    public SubmitApplicationResponse submitApplication(
        ...
        //todo     // 获取 请求的 ApplicationSubmissionContext
        ApplicationSubmissionContext submissionContext = request
                .getApplicationSubmissionContext();
        //todo     // 获取 ApplicationId
        ApplicationId applicationId = submissionContext.getApplicationId();
        //todo     // 获取 CallerContext
        ...
        //todo     // 检测 app是否已经放入到 rmContext 如果已经提交过了,直接返回一个空的响应
        ...
        //todo     //设置队列, 默认 : default
        if (submissionContext.getQueue() == null) {
            submissionContext.setQueue(YarnConfiguration.DEFAULT_QUEUE_NAME);
        }
        //todo     // 设置ApplicationName  默认: N/A
        if (submissionContext.getApplicationName() == null) {
            submissionContext.setApplicationName(
                    YarnConfiguration.DEFAULT_APPLICATION_NAME);
        }
        //todo     // 设置ApplicationType类型  默认: YARN
        ...
        try {
            ...
            //todo       // 请求RMAppManager 提交application
    ...
    public KillApplicationResponse forceKillApplication(
        ...
        //todo     // 想 Dispatcher 发送kill event
